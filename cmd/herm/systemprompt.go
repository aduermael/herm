...
type PromptData struct {
	HasLuau                 bool
	HasBash                 bool
	HasLocalSandboxExec     bool
	HasLocalSandboxExecBash bool
...
func buildSystemPrompt(opts buildSystemPromptOptions) string {
	...
	return renderPromptSections(profile.mainSections, data)
}
...
func buildSubAgentSystemPrompt(opts buildSubAgentSystemPromptOptions) string {
	...
	return renderPromptSections(profile.subAgentSections, data)
}
...
func newPromptData(opts newPromptDataOptions) PromptData {
	...
	return PromptData{
		HasLuau:                 toolNames["luau"] || toolNames[toolLocalSandboxExec],
		HasBash:                 toolNames[toolBash],
		HasLocalSandboxExec:     toolNames[toolLocalSandboxExec],
		HasLocalSandboxExecBash: toolNames[toolLocalSandboxExecBash],
		HostTools:               hostTools,
...
func renderPromptSections(sections []string, data PromptData) string {
	var buf bytes.Buffer
	for _, section := range sections {
		if err := prompts.Templates.ExecuteTemplate(&buf, section, data); err != nil {
