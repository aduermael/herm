...
private struct CPSLOpenAIProtocolChecks {
    ...
    private static func assertChatRequestExposesClientTools() throws {
        ...
        guard let tools = object["tools"] as? [[String: Any]], tools.count == 2,
              ...
              (function["description"] as? String)?.contains("Unix-like local sandbox") == true,
              (function["description"] as? String)?.contains("Luau is the command interface instead of Bash") == true,
              (function["description"] as? String)?.contains("only supported execution language") == true,
              (function["description"] as? String)?.contains(#"Current directory for this request: "/tmp/project""#) == true,
              ...
              (function["description"] as? String)?.contains("Never guess API signatures") == true,
              (function["description"] as? String)?.contains("CPSL") != true,
              (function["description"] as? String)?.contains("Declare variables with local") == true,
              (function["description"] as? String)?.contains("external lua/luau interpreters") == true,
