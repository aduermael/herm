...
private struct CPSLOpenAIProtocolChecks {
    ...
    private static func assertChatRequestExposesClientTools() throws {
        ...
        guard let tools = object["tools"] as? [[String: Any]], tools.count == 2,
              ...
              (function["description"] as? String)?.contains("CPSL, a Unix-like local environment") == true,
              ...
              (function["description"] as? String)?.contains(#"Current CPSL directory for this request: "/tmp/project""#) == true,
              ...
              (function["description"] as? String)?.contains("Never guess CPSL API signatures") == true,
